                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-img">
                                                <a href="/products/{{ $products->first()[0]->id }}">
                                                    <img src="/{{ $products->first()[0]->photos[0]->image }}" alt="product" class="first" />
                                                    <img src="/{{ $products->first()[0]->photos[1]->image }}" alt="product" class="second" />
                                                </a>
                                            </div>
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="/products/{{ $products->first()[1]->id }}">
                                                        <img src="{{ $products->first()[1]->photos[0]->image }}" alt="product" class="first" />
                                                        <img src="{{ $products->first()[1]->photos[1]->image }}" alt="product" class="second" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                            ...
                                            <div class="single-product hidden-sm">
                                                <div class="product-img">
                                                    <a href="/products/{{ $products->first()[2]->id }}">
                                                        <img src="/{{ $products->first()[2]->photos[0]->image }}" alt="product" class="first" />
                                                        <img src="/{{ $products->first()[0]->photos[1]->image }}" alt="product" class="second" />
                                                    </a>
                                                </div>
                                                <div class="product-content">
